                ...
                <tbody>
                    @forelse($members as $row)
                        <tr>
                            ...
                            <td class="border px-4 py-2">{{ $row->konsentrasi }}</td>
                            <td class="border px-4 py-2">{{ $row->judul }}</td>
                            <td class="border px-4 py-2">{{ $row->proposal }}</td>
                            <td class="border px-4 py-2">{{ $row->pembimbing }}</td>
                            <td class="border px-4 py-2">{{ $row->status }}</td>
                            <td class="border px-4 py-2">
                                <button wire:click="delete({{ $row->id }})" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">Decline</button>
